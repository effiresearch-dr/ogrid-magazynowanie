          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-slate-50 rounded-xl border border-slate-100">
                  <span className="text-xs font-bold text-slate-500 uppercase">ROI (5 lat)</span>
                  <span className="text-lg font-black text-slate-900">{financialSummary.roi}%</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-slate-50 rounded-xl border border-slate-100">
                  <span className="text-xs font-bold text-slate-500 uppercase">Okres Zwrotu</span>
                ...
                <div className="flex justify-between items-center p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                  <span className="text-xs font-bold text-emerald-700 uppercase">Oszczędności (5 lat)</span>
                  <span className="text-lg font-black text-emerald-600">{formatNumber(financialSummary.totalSavings5Y, 'PLN')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-[10px] border-b border-slate-50 pb-2">
                  <span className="text-slate-400 font-bold uppercase">CAPEX</span>
                  <span className="text-slate-900 font-black">{formatNumber((bessPower / 1000) * capexPerMW, 'PLN')}</span>
                </div>
                <div className="flex justify-between text-[10px] border-b border-slate-50 pb-2">
                  <span className="text-slate-400 font-bold uppercase">Model Cen</span>
                  <span className="text-slate-900 font-black uppercase">{projectionModel}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 bg-white rounded-3xl border border-slate-100 shadow-sm space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-[10px] font-bold text-slate-400 uppercase">Suma Oszczędności</span>
              <span className="text-sm font-black text-emerald-600">+{formatNumber(financialSummary.totalSavings5Y, 'PLN')}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-[10px] font-bold text-slate-400 uppercase">Całkowity CAPEX</span>
              <span className="text-sm font-black text-slate-900">{formatNumber(financialSummary.totalCosts, 'PLN')}</span>
            </div>
